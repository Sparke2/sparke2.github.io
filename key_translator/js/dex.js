    ...
    function AliceFunc1() {
      ...
      //alert(ethUtil.privateToPublic(new Buffer(privToDecrypt, 'hex')).toString('hex'));
     ...
     // $('#output-Keccak-256').val(keccak256OfPub);
      ...
      //alert(ethUtil.publicToAddress(ethUtil.privateToPublic(new Buffer(privToDecrypt, 'hex'))).toString('hex'));
